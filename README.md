...
1. Identify 5 – 7 Key Performance Indicators (KPIs) for the Department of Transport.

2. Create a single dashboard of information for management review.

3. Visually display the KPIs and justify each KPI’s selection and design.
...
1. airports.csv: Information about the airports.
